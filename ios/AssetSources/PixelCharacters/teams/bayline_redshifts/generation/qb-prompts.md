# Bayline Redshifts quarterback rebuild prompts
...
Uniform: Bayline Redshifts PRIMARY, fully authored opaque colors. Helmet and jersey wine #842C4B. Shoulder panels and pants copper #C87845. Back number 7, trim, waistband accents, and socks cool silver #DFE5E2. Facemask and cleats neutral graphite. Gloves neutral white with restrained team-color trim. Natural warm skin. Brown leather football with white laces. Use these defined colors as the dominant local colors with darker same-family shadows and restrained lighter highlights only; never let one material's color spill into another material.
...
```text
/Users/andypark/.codex/generated_images/019f7c71-421d-79e0-97fb-bf4d737d67bc/exec-70a56033-df14-4674-a1a3-d76cda42a331.png
```
...
Uniform: Bayline Redshifts ALTERNATE, fully authored opaque colors. Helmet and jersey copper #C87845. Shoulder panels and pants cool silver #DFE5E2. Back number 7, trim, waistband accents, and socks wine #842C4B. Facemask and cleats neutral graphite. Gloves neutral white with restrained team-color trim. Natural warm skin. Brown leather football with white laces. Use these defined colors as the dominant local colors with darker same-family shadows and restrained lighter highlights only; never let one material's color spill into another material.
...
```text
/Users/andypark/.codex/generated_images/019f7c71-421d-79e0-97fb-bf4d737d67bc/exec-ee018837-fef2-40c8-891c-8a3bfbed75f5.png
```

## QA/iteration notes

The canonical alternate raw output placed four edge pixels of the airborne football across the third/fourth slot boundary. After key removal, the intact authored football component was translated 100 pixels left inside frame 3 without rescaling, recoloring, masking the uniform, or changing any character pixels. A targeted regeneration (`exec-629a1c76-92a3-4171-a32f-e92314bdfaf2.png`) corrected the position but was rejected because it introduced a pink hue wash into skin and gloves.
