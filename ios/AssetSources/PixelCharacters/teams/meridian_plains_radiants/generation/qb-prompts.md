# Meridian Plains Radiants quarterback rebuild prompts
...
Uniform: Meridian Plains Radiants PRIMARY, fully authored opaque colors. Helmet and jersey crimson #C72F4F. Shoulder panels and pants warm orange #F0A253. Back number 7, trim, waistband accents, and socks warm white #FFF0DD. Facemask and cleats neutral graphite. Gloves neutral white with restrained team-color trim. Natural warm skin. Brown leather football with white laces. Use these defined colors as the dominant local colors with darker same-family shadows and restrained lighter highlights only; never let one material's color spill into another material.
...
```text
/Users/andypark/.codex/generated_images/019f7c71-421d-79e0-97fb-bf4d737d67bc/exec-bed6b1ea-13a8-4502-8184-fb8169480e6f.png
```
...
Uniform: Meridian Plains Radiants ALTERNATE, fully authored opaque colors. Helmet and jersey warm orange #F0A253. Shoulder panels and pants warm white #FFF0DD. Back number 7, trim, waistband accents, and socks crimson #C72F4F. Facemask and cleats neutral graphite. Gloves neutral white with restrained team-color trim. Natural warm skin. Brown leather football with white laces. Use these defined colors as the dominant local colors with darker same-family shadows and restrained lighter highlights only; never let one material's color spill into another material.
...
```text
/Users/andypark/.codex/generated_images/019f7c71-421d-79e0-97fb-bf4d737d67bc/exec-6033ddde-5911-42a8-9dcb-e7b62c501dcc.png
```
